...
echo '</td>';
echo '<td>';
echo '<input type="password" id="txtBox" value="" name="contrasena2">';
echo '</td>';
echo '</tr>';
echo '<tr>';
echo '<td>';
...
echo '</tr>';
echo '<table>';
echo '<a href="deber6.php" id="enlance" >¿Por que debo proporcionar esta informacion?</a> <br>';
echo '<br>';
